...
if __name__=="__main__":
  ...
  phantom = Phantom(spins, p, patient=False, z_motion=False, write_vtk=False, rigid_body_motion=5*2*np.pi/ke)
  ...
  # Generate images
  start = time.time()
  NSA_1, NSA_2, REF, mask = I.generate(None, phantom, p, debug=True)
  end = time.time()
  print(end-start)
